...
The code here is not released under any license or free for general use.  The code from Blake2.net is considered CCO Licensed, and does not require the updated implementation to be released, though it may be at some point in the future.  It is being adapted as necessary and with time if a working solver is created, a licensed release will be considered.
